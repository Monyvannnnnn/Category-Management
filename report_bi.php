...
<head>
    ...
    <style>
        /* BI Dashboard Custom Dark Theme Enhancements */
        .bi-page-container {
            width: 100vw;
            height: 100vh;
            display: flex;
        ...
        @media print {
            ...
            .bi-header-actions, .table-controls {
                display: none !important;
            }
            .kpi-card, .chart-card, .bi-table-card {
                border: 1px solid #ccc !important;
                background: #fff !important;
                color: #000 !important;
                box-shadow: none !important;
            }
            .kpi-value, .chart-card-title, .bi-title-text h1 {
                color: #000 !important;
            }
        }
    </style>
